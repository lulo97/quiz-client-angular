...
import { empty_record, ISubject } from "./utils";
import { DatePipe } from "@angular/common";
import { InputTextareaModule } from "primeng/inputtextarea";
import { CRUD_ACTION } from "../../utils";

const SELECTOR = "Subject";
const TEMPLATE_URL = "./subject.html";
const _SCREEN = {
  NAME_VI: "Môn học",
  NAME_EN: "Subject",
};
...
export class Subject {
  ...
  description: string = "";
  datas: ISubject[] = [];
  selected_record: ISubject = empty_record;
  ...
  handleOpenRead(selected_record: ISubject) {
    this.VISIBLE_DIALOG.READ = true;
    this.selected_record = selected_record;
  }

  handleOpenEdit(selected_record: ISubject) {
  ...
  handleOpenDelete(selected_record: ISubject) {
  ...
  handleEdit() {
    ...
    const body = {
      subjectId: this.selected_record.subjectId,
      name: this.name,
      description: this.description,
